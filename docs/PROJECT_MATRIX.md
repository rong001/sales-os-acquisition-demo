...
| USGate | [已交付 demo](https://github.com/rong001/usgate-demo) · [已交付 client](https://github.com/rong001/usgate-client) | [已交付](https://117.55.227.224:8443/)（MOCK 隔离门户；Let’s Encrypt IP 证书，2026-09-22 TLS 核验通过；不连真实 3X-UI） | VPS + Caddy/门户 Compose；3X-UI 为生产预期、演示未接真面板 | 隧道/重连/流量已测；MOCK 门户公网可开；Android 源码仓已公开 | 门户公网 HTTPS **可访问**；真机 Android E2E 仍可能 BLOCKED（以对方为准） | 真机安装；面板/商用凭据用户侧；演示账号见对方 README（demo-only） |
...
- 2026-09-22：USGate 对公 MOCK 门户 https://117.55.227.224:8443/ TLS 核验后演示列标「已交付」。
