...
| 获客（本仓库） | [已交付](https://github.com/rong001/sales-os-acquisition-demo) | **公网 HTTPS 部署推进中**（此前仅本机 E2E PASS，**不得**标公网可用） | 本地 npm；Compose 文件有、本机构建引擎未装故 Compose 未实测 | 落地页（抢票+USGate）、UTM/邀请码、同意留资、去重、分配、跟进、预约、漏斗、管理导出；触达标 MOCK | 本机 E2E **PASS**；公网 HTTPS E2E **待测** | 公网 HTTPS 演示与验收；Compose 引擎 |

## 更新记录

- 2026-09-22：抢票演示改为核验通过的 `https://159.75.71.192:18444/`；明确 ToC 注册/真实购买等未通过项。  
- 2026-09-22：USGate 增加 `usgate-client`；仓库已交付；演示仍待发布（证书声称≠已交付 URL）。  
- 2026-09-22：获客标明「本机 E2E≠公网可用」；公网 HTTPS 部署中。
